...
if os.path.exists(model_path):
    ...
    model, history = train_model(input_dim, X_train, y_train)
    model.save_weights(model_path)
    print("Model trained and saved to disk.")
...
if history:
    ...
    plt.tight_layout()
    plt.savefig("bdtplots/dnn/training_validation_plots.png")
    plt.savefig("bdtplots/dnn/training_validation_plots.pdf")
    plt.show()
else:
    print("Training history not available. Skipping history plots.")
