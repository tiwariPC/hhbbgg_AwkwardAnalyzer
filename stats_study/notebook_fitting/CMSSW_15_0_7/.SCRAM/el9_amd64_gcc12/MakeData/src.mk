...
GENERATED_EDMPLUGIN_DIR:=$(if $(strip $(_BUILD_TIME_MICROARCH)),$(SCRAMSTORENAME_LIB)/$(_BUILD_TIME_MICROARCH),$(SCRAMSTORENAME_LIB))
PLUGIN_REFRESH_CMDS += edmPluginRefresh
define do_edmPluginRefresh
  $(CMD_echo) "@@@@ Refreshing Plugins:edmPluginRefresh for $(1)" &&\
$(EDM_TOOLS_PREFIX) edmPluginRefresh $(1)
endef
$(GENERATED_EDMPLUGIN_DIR)/.edmplugincache: $(SCRAM_INTwork)/cache/edm_edmPluginRefresh $(SCRAM_INTwork)/cache/prod/edmPluginRefresh
...
GENERATED_RIVETPLUGIN_DIR:=$(if $(strip $(_BUILD_TIME_MICROARCH)),$(SCRAMSTORENAME_LIB)/$(_BUILD_TIME_MICROARCH),$(SCRAMSTORENAME_LIB))
PLUGIN_REFRESH_CMDS += RivetPluginRefresh
define do_RivetPluginRefresh
  $(CMD_echo) "@@@@ Refreshing Plugins:RivetPluginRefresh for $(1)" &&\
$(EDM_TOOLS_PREFIX) RivetPluginRefresh $(1)
endef
$(GENERATED_RIVETPLUGIN_DIR)/.rivetcache: $(SCRAM_INTwork)/cache/rivet_RivetPluginRefresh $(SCRAM_INTwork)/cache/prod/RivetPluginRefresh
...
GENERATED_DD4HEPPLUGIN_DIR:=$(if $(strip $(_BUILD_TIME_MICROARCH)),$(SCRAMSTORENAME_LIB)/$(_BUILD_TIME_MICROARCH),$(SCRAMSTORENAME_LIB))
PLUGIN_REFRESH_CMDS += DD4HepPluginRefresh
define do_DD4HepPluginRefresh
  $(CMD_echo) "@@@@ Refreshing Plugins:DD4HepPluginRefresh for $(1)" &&\
$(EDM_TOOLS_PREFIX) DD4HepPluginRefresh $(1)
endef
$(GENERATED_DD4HEPPLUGIN_DIR)/.dd4hepcache: $(SCRAM_INTwork)/cache/dd4hep_DD4HepPluginRefresh $(SCRAM_INTwork)/cache/prod/DD4HepPluginRefresh
